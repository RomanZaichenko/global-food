  ...
  return (
    <>
      <div className="map">
        ...
        <Pointer country="turkey" x={223} y={165} rotate={0} onClick={() => handlePointerClick("turkey")} />
        <Pointer country="italy" x={205} y={170} rotate={0} onClick={() => handlePointerClick("italy")} />
        <Pointer country="france" x={175} y={145} rotate={0} onClick={() => handlePointerClick("france")} />
        <Pointer country="germany" x={195} y={149} rotate={0} onClick={() => handlePointerClick("germany")} />
        <Pointer country="switzerland" x={173} y={163} rotate={0} onClick={() => handlePointerClick("switzerland")} />
        <Pointer country="uk" x={175} y={120} rotate={0} onClick={() => handlePointerClick("uk")} />
        ...
        <Pointer country="japan" x={296} y={220} rotate={0} onClick={() => handlePointerClick("japan")} />
      </div>
    </>
  )
}